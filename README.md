...
- [版本進度](docs/version-progress.md)比較繁中服與國際服的主要／小版本上線日期，提供各版時長、跨列的主版本總時長、開服歷程、同版本間隔、跨版本內容對照與官方來源；猜測模式顯示兩服首次進度交會、後續小版及可能開始同步的主版本，同步更新各版與主版總時長，保留官方預定月份並支援分享選取。

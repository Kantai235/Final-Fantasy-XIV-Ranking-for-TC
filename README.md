...
- 極澤蓮尼亞除了完整繁中隊伍的角色傷害固定範圍外，若玩家來源列不完整，會改以已保存或查得的 FFLogs 敵方承傷檢查同一個 `92,086,132–92,086,332` 固定範圍；避免 93.63m 類資料因缺少一名玩家列而略過固定總傷害規則。

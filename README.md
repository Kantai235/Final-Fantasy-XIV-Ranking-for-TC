...
- [版本進度](docs/version-progress.md)比較繁中服與國際服的主要／小版本上線日期，提供各版時長、跨列的主版本總時長、開服歷程、同版本間隔、跨版本內容對照與官方來源；摘要、版本面板與詳情的相隔天數固定為兩服發布日差，摘要的縮短天數只隨已核對的新版本更新；持續中時長與開服天數依台灣當日日期更新。猜測模式顯示兩服首次進度交會、後續小版及可能開始同步的主版本，同步更新各版與主版總時長，保留官方預定月份並支援分享選取。追上倒數、下一版倒數、日期到期提示與圖表今天標記共用台灣時鐘，日期經過仍須核對實際更新。

...
- 零式量級踏破徽章會依四層有效版本公開成績的完成時間，只顯示同量級最高階的一枚：輕量級在繁中服時間 2026-03-17 16:00（含門檻當下）前完成 M1S～M4S 為「輕量級【首週】踏破」，在 2026-03-24 16:00 前完成為「輕量級【次週】踏破」，之後為一般「輕量級踏破」；次重量級在 2026-08-11 16:00 前完成 M5S～M8S 為「次重量級【首週】踏破」，在 2026-08-18 16:00 前完成為「次重量級【次週】踏破」，之後為一般「次重量級踏破」。完成時間由 FFLogs 戰鬥開始時間加上通關時間計算；缺少任一必要時間時不會猜測首週或次週，只保留一般踏破成就。
